...
try:
    ...
    st.markdown(f\"\"\"<div style='background-color: #f8f9fa; padding: 15px; border-radius: 0 0 12px 12px; border: 1px solid #ddd; display: flex; justify-content: center; gap: 30px; font-family: Arial; font-size: 14px;'>
